...
<body>
      <header>
            ...
            <div class="menu-icons">
                  ...
                  <a href="<?php echo $base_url; ?>logout.php" title="Cerrar sesión" style="display: flex; align-items: center; gap: 6px;" onclick="return confirm('¿Seguro que deseas cerrar sesión?');">
